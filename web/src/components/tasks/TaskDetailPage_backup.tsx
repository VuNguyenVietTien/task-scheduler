              ...
              <div className="bg-white rounded-lg">
                ...
                <div className="grid grid-cols-1 gap-2">
                  ...
                  <div className="mt-6 border-t border-gray-200 pt-4">
                    ...
                    {/* Thứ tự ưu tiên */}
                    <div className="flex items-center py-1.5 rounded-md hover:bg-gray-50">
                      <div className="flex-shrink-0 w-1/3 text-sm font-medium text-gray-700">Thứ tự ưu tiên:</div>
                      <div className="flex-1 text-sm text-gray-900">
                        {task.priority_order !== undefined ? task.priority_order : 'Chưa thiết lập'}
                      </div>
                    </div>
                  </div>
